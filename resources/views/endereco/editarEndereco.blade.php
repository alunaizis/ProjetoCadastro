...
<div class="container">
  ...
  <div class="col-10">
    <input class="form-control" type="text"  id="cep" name="cep" value={{$endereco->cep}}>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-10">
    <input class="form-control" type="text"  id="logradouro" name="logradouro" value={{$endereco->logradouro}}>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-10">
    <input class="form-control" type="text"  id="numero"name="numero" value={{$endereco->numero}}>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-10">
    <input class="form-control" type="text" id="complemento" name="complemento" value={{$endereco->complemento}}>
  </div>

  <div class="form-group row">
  <label for="bairro" class="col-2 col-form-label">bairro</label>
  <div class="col-10">
    <input class="form-control" type="text"  id="bairro"name="bairro" value={{$endereco->bairro}}>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-10">
    <input class="form-control" type="text"  id="cidade"name="cidade" value={{$endereco->cidade}}>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-10">
    <input class="form-control" type="text"  id="estado"name="estado" value={{$endereco->estado}}>
  </div>
</div>
